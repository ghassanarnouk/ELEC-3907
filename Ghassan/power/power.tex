...
\hypersetup{pdftitle={Smart Solar Panel System Power},
...
%               max space between ticks=1,
                ...
                xlabel=Time Unit,
                ylabel=Power (w),]
                \addplot[color=red, mark=*, mark size=0.4, style=thick]table[x=Time, y=Power, col sep=comma]{solar.csv};
            \end{axis}
        \end{tikzpicture}
    \captionof{figure}{Power Plot}
    \label{fig:vPlot}
    \end{figure}
    \clearpage
    \section{Data Table}
