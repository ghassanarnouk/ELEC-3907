...
\hypersetup{pdftitle={Smart Solar Panel System Current},
...
%               max space between ticks=1,
                ...
                xlabel=Time Unit,
                ylabel=Power (w),]
                \addplot[color=red, mark=*, mark size=0.4, style=thick]table[x=Time, y=Current, col sep=comma]{solar.csv};
            \end{axis}
        \end{tikzpicture}
    ...
    \begin{table}[htbp]
        \centering
        \caption{Data collect using solar panel}
