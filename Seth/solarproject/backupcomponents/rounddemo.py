...
class TestWidget(QWidget, Ui_TestWidget):
    def __init__(self, parent=None):
        ...
        self.setupUi(self)
        self.setStyleSheet("background-color: #2d2e30;")

        self.RoundBar1.setFormat('%v')
        self.RoundBar1.setDecimals(0)
        self.RoundBar1.setValue(75)
        ...
        p1 = QPalette()
        p1.setBrush(QPalette.AlternateBase, QColor('#2d2e30'))
        p1.setColor(QPalette.Text, Qt.white)
        self.RoundBar4.setPalette(p1)

        self.RoundBar4.setNullPosition(QRoundProgressBar.PositionBottom)
        self.RoundBar4.setDecimals(0)
        gradientPoints = [(0, QColor('#D6ECEF')), (0.6, QColor('#028A0F')), (0.70, Qt.yellow), (1, QColor('#D21404'))]
        self.RoundBar4.setDataColors(gradientPoints)
        self.RoundBar4.setValue(75)
        p2 = QPalette(p1)
